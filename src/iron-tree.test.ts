...
describe('iron-tree', () => {
    ...
    it("should return elements in the order they were added when getting elements", (done) => {
        var t = new IronTree.Tree<string>();
        t.add('test', 'test0');
        t.add('test', 'test1');
    ...
    it("should return elements in the order they were added when getting all elements", (done) => {
        var t = new IronTree.Tree<string>();
        t.add('test', 'test0');
        t.add('test.2', 'test1');
        t.add('test', 'test-removed');
